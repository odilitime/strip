...
async function charset2homophonesSecret(frequency, charset, max, secret, cb) {
...
function charset2homophones(frequency, charset, max) {
  return charset2homophonesEngine(frequency, charset, max, function(slotMap, totalFreqSlots) {
